...
const Slug = ({ addToCart }) => {
    ...
    const checkServicibility = async () => {
        ...
        if (pinsJson.includes(parseInt(pin))) setService(true);
            ...
            <section className="text-gray-600 body-font overflow-hidden">
                <div className="container px-5 py-16 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto object-cover object-top rounded" src="https://m.media-amazon.com/images/I/51EhbjnQ6BL._UL1080_.jpg" />
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <div className="flex">
                                ...
                                <button onClick={() => addToCart(slug, 1, 499, "wear the code(XL/Blue)", "XL", "Blue")} className="flex ml-auto text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded">Add to cart</button>
                            ...
                            <div className="mt-10">
                                <input type="text" name="pincode" placeholder='Enter Pincode' className='border-b-[1px] border-pink-500 w-50 mr-3 focus:outline-none' onChange={handlePin} />
